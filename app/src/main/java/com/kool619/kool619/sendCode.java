                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Intent intent = new Intent(sendCode.this, CustomerFoodPanel_BottomNavigation.class);
                                startActivity(intent);
                                finish();
                            } else {
                                ReusableCodeForAll.ShowAlert(sendCode.this,"Error",task.getException().getMessage());
                            }
                        }
                    });
        } catch (Exception e) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(FirebaseException e) {
                        Toast.makeText(sendCode.this, "THis 2:" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
